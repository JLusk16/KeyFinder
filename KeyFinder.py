...
#     tstart and tend: the range in seconds of the file to be analyzed; default to the beginning and end of file if not
#       specified
...
#class ConvertWav(object):
    def __int__(self, src, dst):
        ...
        wav_file = sound.export(self, dst, format="wav")
        return wav_file
